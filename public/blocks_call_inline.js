...
Blockly.Blocks.dynamic_call_inline = {
  /**
...
Blockly.JavaScript.dynamic_call_inline = function (block) {
  let obj = block_to_obj(block, 'call_inline', ['name'], [], []);
  obj.args = [];
  for (let i=0; i<block.length_; i++) {
    obj.args.push(value_to_obj(block, "ADD" + i));
  }
  return blockobj_to_json('call_inline', block, obj);
}
